package com.xpxcoder.xpxDroid.widget.CustomRefleshListView;
...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView(Context context) {
        ...
        View view = layoutInflater.inflate(R.layout.widget_customrefleshlistview_footer,
                null);
