package com.xpsoft.xpxDroid.receivers;
...
import com.xpsoft.xpxDroid.views.LockScreenMsgActivity;
...
public class LockScreenMsgReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals("com.xpsoft.xpxDroid.receivers.LockScreenMsgReceiver")) {
            //管理锁屏的一个服务
            ...
            if (km.inKeyguardRestrictedInputMode()) {
                ...
                //判断是否锁屏
                Intent alarmIntent = new Intent(context, LockScreenMsgActivity.class);
